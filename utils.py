...
def create_baseline_dataloader(dataset_type):
    ...
    if dataset_type == 'foreground':
        train_loader = DataLoader(foreground_train_dataset, batch_size=64, num_workers=4, shuffle=True)
        test_loader = DataLoader(foreground_test_dataset, batch_size=16, num_workers=4, shuffle=True)
    elif dataset_type == 'composite':
        train_loader = DataLoader(composite_train_dataset, batch_size=64, num_workers=4, shuffle=True)
        test_loader = DataLoader(composite_test_dataset, batch_size=16, num_workers=4, shuffle=True)
...
def create_cl_dataloader():
    ...
    foreground_train_loader = DataLoader(foreground_train_dataset, batch_size=64, num_workers=4, shuffle=True)
    foreground_test_loader = DataLoader(foreground_test_dataset, batch_size=16, num_workers=4, shuffle=True)
    composite_train_loader = DataLoader(composite_train_dataset, batch_size=64, num_workers=4, shuffle=True)
    composite_test_loader = DataLoader(composite_test_dataset, batch_size=16, num_workers=4, shuffle=True)
